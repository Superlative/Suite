-- SafeQueue by Jordon 
-- Stolen code (sorry) all credits to the creator : http://www.curse.com/addons/wow/safequeue
-- Removes the "leave que" of the join arena/bg window
...
function SafeQueue:Command(msg)
	...
	if cmd == "announce" then
		...
		DEFAULT_CHAT_FRAME:AddMessage("|cff33ff99SafeQueue v2.1|r")
